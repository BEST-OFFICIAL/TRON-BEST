...
contract TokenWrapper {
    ...
    IERC20 public tokenAddr = IERC20(0x9eD390f2dcee8F4Fb80Bc3f7608f1690c455DD8B); // best-usdt lp token
...
contract Mine_BEST_USDT_LP_Pool is TokenWrapper, Ownable {
    ...
    constructor() public{
        ...
        rewardPerDuration = uint(22500) * 1e6;
    ...
    function withdrawAndGetReward(uint amount) public checkLock updateReward(msg.sender) {
    ...
    function getReward() public updateReward(msg.sender) checkLock {
        ...
        if (trueReward > 0) {
            ...
            rewardToken.safeTransfer(msg.sender, trueReward.mul(userRate).div(100));
